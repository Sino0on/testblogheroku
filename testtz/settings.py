"""
Django settings for testtz project.
...
SECRET_KEY = 'django-insecure-%p9qn-!^y^0_&=h#zmg_cg%!$tr-)e3@+#t!-l0x58^-g&%*$&'
...
WSGI_APPLICATION = 'testtz.wsgi.application'
